...
INSERT INTO products (id, name, variant, size, pattern, company, design, category, price, costPrice, stock, stockAlwaysNeeded, avgStockNeeded, reorderStatus, notes, photoUrl, updatedAt) VALUES
('p-101', 'Stainless Saucepan 2L', NULL, NULL, NULL, NULL, NULL, 'Cookware', 120000, 80000, 50, 1, 20, 'ok', NULL, NULL, '2025-11-01 00:00:00'),
('p-102', 'Cast Iron Tawa', NULL, NULL, NULL, NULL, NULL, 'Cookware', 95000, 65000, 30, 1, 15, 'ok', NULL, NULL, '2025-11-01 00:00:00'),
('p-103', 'Copper Bottle 1L', NULL, NULL, NULL, NULL, NULL, 'Bottles', 45000, 30000, 40, 0, 10, 'ok', NULL, NULL, '2025-11-01 00:00:00');

-- Now insert November 2025 sales data
